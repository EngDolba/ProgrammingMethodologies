...
{
	HashMap<String, NameSurferEntry> names = new HashMap<String, NameSurferEntry>();

	/* Constructor: NameSurferDataBase(filename) */
	/**
	 * Creates a new NameSurferDataBase and initialises it using the data in the
	...
	public NameSurferDataBase(String filename)
	{
		try
		{
			...
			while (true)
			{
				...
				names.put(name, new NameSurferEntry(line));
			}
			rd.close();
		} catch (Exception e)
		{
